"""CLI for S63 target FullContext HTTP delta live runtime eval."""
...
from evals.v5.s63_target_runtime_live_harness import prepare_live_run, run_http_harness
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--live",
        action="store_true",
        help="Run one owner-approved S63 live attempt",
    )
    parser.add_argument(
    ...
    if args.offline:
        print(
            "Use pytest tests/test_s63_target_runtime_live_harness.py for offline harness",
            file=sys.stderr,
        )
        return 0

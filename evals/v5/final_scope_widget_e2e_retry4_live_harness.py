"""HTTP harness for FINAL scope/widget E2E retry4 live runtime eval."""
...
from evals.v5.final_scope_widget_e2e_retry4_live_provider_audit import (
    provider_audit_context as retry4_provider_audit_context,
...
def prepare_retry4_live_run(
    *,
    ...
    prepare_live_run(
        ...
        build_marker_payload=build_retry4_attempt_marker_payload,
...
def run_http_harness(
    *,
    ...
    _harness_module.provider_audit_context = retry4_provider_audit_context
    _harness_module.set_current_turn = retry4_set_current_turn
    _harness_module.record_fullcontext_build = retry4_record_fullcontext_build
    try:

...
**Честно:** ранние версии выдавали переходную форму за целевую и содержали внутренние противоречия. Исправлено. Помечено **TARGET** vs **СЕЙЧАС**. Опора: `docs/ARCH_RECON_REPORT.md`.

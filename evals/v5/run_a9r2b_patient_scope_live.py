"""CLI for A9R2b patient-scope planner live eval."""
...
from evals.v5 import a9r2b_patient_scope_live_contract as contract  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--live",
        action="store_true",
        help="Run one owner-approved A9R2b live planner attempt",
    )
    parser.add_argument(

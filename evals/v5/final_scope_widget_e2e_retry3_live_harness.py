"""HTTP harness for FINAL scope/widget E2E retry3 live runtime eval."""
...
import evals.v5.final_scope_widget_e2e_live_harness as _harness_module
...
from evals.v5.final_scope_widget_e2e_retry3_live_provider_audit import (
    provider_audit_context as retry3_provider_audit_context,
...
def prepare_retry3_live_run(
    *,
    ...
    prepare_live_run(
        ...
        build_marker_payload=build_retry3_attempt_marker_payload,
...
def run_http_harness(
    *,
    ...
    prior_audit = _harness_module.provider_audit_context
    prior_set_turn = _harness_module.set_current_turn
    prior_record_fc = _harness_module.record_fullcontext_build
    _harness_module.provider_audit_context = retry3_provider_audit_context
    _harness_module.set_current_turn = retry3_set_current_turn
    _harness_module.record_fullcontext_build = retry3_record_fullcontext_build
    try:
        ...
        _harness_module.provider_audit_context = prior_audit
        _harness_module.set_current_turn = prior_set_turn
        _harness_module.record_fullcontext_build = prior_record_fc

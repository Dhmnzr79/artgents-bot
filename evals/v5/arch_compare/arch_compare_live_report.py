...
def _public_review_text(text: str | None, *, code_only: bool) -> str:
    if code_only:
    ...
    for scenario_id, rows in by_scenario.items():
        ...
        for turn_id in turn_ids:
            ...
            for variant in BLIND_VARIANTS:
                ...
                visible = _public_review_text((match or {}).get("visible_answer"), code_only=code_only)

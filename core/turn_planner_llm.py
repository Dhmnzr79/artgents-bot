...
_SYSTEM = (
    ...
    "contacts — прямой вопрос про телефон, адрес, часы работы, WhatsApp, парковку, как доехать.\n"
    ...
    "Ставь сценарий только при выраженном страхе, сомнении или возражении пациента. "
    "Прямой информационный вопрос ≠ сценарий: «Сколько длится?» не time; "
    "«Какая гарантия?» не result_reliability; «Кто врач?» не doctor_trust. "
    "При сомнении верни [].\n"

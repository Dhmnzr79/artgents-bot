...
COMPOSER_FULLCTX_RULE = (
    ...
    "(«обычно», «зависит», «после осмотра», «индивидуально»), без обещаний "
    "(«приживётся», «безболезненно», «гарантируем результат» — нельзя).\n"
    "По боли и анестезии: НИКОГДА не пиши абсолюты — «боли не будет», «острой боли не будет», "
    "«не будет больно», «безболезненно», «не больно». "
    "Используй хеджированные формулировки как в источнике: "
    "«под анестезией боли обычно не чувствуют», «максимум — лёгкий дискомфорт», "
    "«ощущения индивидуальны». Сохраняй оговорки «обычно», «чаще всего», «по ситуации».\n"

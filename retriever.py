...
def llm_rerank(q: str, cands: list) -> dict:
    """DEPRECATED — see DEPRECATED.md; use ``core.retrieval_rerank.maybe_rerank_top``."""
    from core.retrieval_rerank import llm_rerank_candidates

    result, _tel = llm_rerank_candidates(q, cands)
    return result

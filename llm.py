...
COMPOSER_FULLCTX_NO_KB_ANSWER_RULE = (
    ...
    "Это касается и бытовых/организационных деталей о клинике, которых нет в базе "
    "(можно ли поесть или попить в зоне ожидания, парковка, Wi-Fi, можно ли прийти с сопровождающим "
    "и т.п.): не подтверждай их «из здравого смысла» — если этого нет в базе, честно скажи, что "
    "такую деталь уточнит администратор. "

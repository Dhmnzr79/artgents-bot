"""Provider transport audit for S66 default authority live eval (5-call budget)."""
...
def _record_call_started(
    *,
    ...
    with _LOCK:
        ...
        if total_for_role > _role_budget(role):
            raise ProviderRoleViolationError(

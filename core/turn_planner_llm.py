...
_SYSTEM = (
    ...
    "contact_phone, contact_address, contact_parking, contact_hours, contact_whatsapp, service_availability. "
    ...
    "service_availability — пациент спрашивает, оказывает ли клиника самостоятельную услугу/процедуру "
    "(«делаете», «есть ли», «проводите» + конкретная услуга из каталога). Верни service_id из каталога и "
    "aspects=[\"service_availability\"]. Не используй service_availability для технологий, материалов, "
    "оборудования, стерильности, стандартов безопасности или организационных возможностей — это обычный "
    "информационный content/overview без service_id или с service_id=null. "
    "Не используй service_availability, если пациент спрашивает про своё/имеющееся исследование, можно ли "
    "прийти со своим КТ, актуальность или свежесть снимка, нужно ли повторное КТ или подготовку — "
    "верни aspects=[\"overview\"] и service_id услуги (например tomography), если вопрос продолжает тему КТ.\n"

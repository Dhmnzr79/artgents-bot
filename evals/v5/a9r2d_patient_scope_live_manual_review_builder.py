"""Build full manual review artifact from A9R2d live result."""
...
from evals.v5.a9r2c_patient_scope_live_manual_review_builder import (
    build_manual_review_from_result as _build_from_result,
)
from evals.v5.a9r2d_patient_scope_live_contract import (

...
- HTTP integration, lead/privacy мост и replay результата — **не начаты**.
  Live-проверка ограниченно доказана только для CP3 A08, не для общего runtime.

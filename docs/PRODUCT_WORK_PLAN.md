...
- [ ] Выбрать **пилотного клиента** для первой батареи (рекомендация: `demo`, затем `cesi`)
...
| | |
|--|--|
| **Срок** | 3–10 дней / **код 1 день**, контент **3–7 дней** (владелец) |
...
**Цель:** заметный скачок за **5–7 календарных дней** при участии владельца контента.

| День | Фокус |
|------|--------|
| 1 | Eval 25 вопросов; починить catalog↔price на demo; 3 comparison md (черновики) |
| 2 | **Answer slots** в коде; поля в 3–5 service md |
| 3 | Контент: bone_graft, contraindications, pain; прогон golden |
...
**Параллельно:** cesi — только после зелёного demo на том же механизме.
